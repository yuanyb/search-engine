...
//	// 10 秒有效期
//	if time.Now().Unix()-atomic.LoadInt64(&db.docsCountBuffer.birthday) < 10 {
//		return int(atomic.LoadInt64(&db.docsCountBuffer.count)), nil
//	}
//
//	db.docsCountBuffer.lock.Lock()
//	defer db.docsCountBuffer.lock.Unlock()
//	// 双重检查
//	if time.Now().Unix()-db.docsCountBuffer.birthday < 10 {
//		return int(db.docsCountBuffer.count), nil
//	}
//	var count int
